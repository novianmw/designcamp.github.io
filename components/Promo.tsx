...
export default function Promo() {
    return (
        <section className="flex flex-col justify-center w-3/4 items-center my-12 p-12 border-2 border-[#FFA500] rounded-xl bg-[#FFA500]/20 ">
            <div className="flex flex-col text-center items-center py-12">
                <h1 className={`font-semibold text-[28px] md:text-[36px] pb-3 ${slab.className}`}>
                    Limited-time Promotion
                </h1>
                <p className="font-normal text-[16px] md:text-[24px] pb-6">
